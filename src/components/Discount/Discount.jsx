...
const Discount = () => {
  return (
    ...
    >
      <div className='flex md:flex-row flex-col max-w-[1400px] mx-auto px-10 py-10 mb-20'>
        <span className='md:text-9xl text-5xl text-teal-500 font-bold transform md:-rotate-90 h-fit md:self-center'
        >
          20%
        </span>
